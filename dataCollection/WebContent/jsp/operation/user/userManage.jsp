...
<title>用户管理</title>
	...
	<!-- 自定义js加载 -->
	<script type="text/javascript" src="<%=basePath%>jsp/operation/user/js/userManager.js"></script>
</head>
...
<div id="body" region="center"  > 
    ...
    <form method="get">
      <table border="0">
        <tr>
          ...
          <td>
             &nbsp;&nbsp; <a  href="javascript:void(0)" id="queryUser" class="easyui-linkbutton my-search-button" iconCls="icon-search" plain="true">查询</a> 
  ...
  <div id="tt_btn">
      ...
      <!-- 弹出框 -->
            <div id="showUser"  style="padding:10px;">
