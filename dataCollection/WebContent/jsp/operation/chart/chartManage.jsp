...
<title>图标</title>
	...
	<script type="text/javascript" src="<%=basePath%>jsp/operation/chart/js/chartManage.js"></script>
...
<script src="<%=basePath%>jsp/resource/highchart/highcharts.js"></script>
<script src="<%=basePath%>jsp/resource/highchart/exporting.js"></script>